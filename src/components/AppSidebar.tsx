import { LayoutDashboard, Monitor, Package, BarChart3, Settings, LogOut, Receipt, ShoppingCart, ShieldCheck, Users as UsersIcon } from "lucide-react";
...
export const navItems = [
  ...
  { icon: Monitor, label: "Assets", path: "/assets" },
  { icon: Package, label: "Stock", path: "/stock" },
  { icon: Receipt, label: "Bayar Bulanan", path: "/bills" },
  { icon: ShoppingCart, label: "Belanja", path: "/purchases" },
  { icon: ShieldCheck, label: "Klarifikasi Asset", path: "/clarifications" },
