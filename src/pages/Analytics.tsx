...
const STATUS_LABELS: Record<string, string> = {
  new: "Registered", assigned: "Assigned", in_progress: "In Repair",
  testing: "Inspection", resolved: "Deployed", closed: "Retired",
};
...
export default function Analytics() {
  ...
  const trendChartConfig: ChartConfig = { count: { label: "Assets Added", color: "hsl(234, 55%, 60%)" } };
  ...
  const areaChartConfig: ChartConfig = { open: { label: "Active", color: "hsl(38, 92%, 50%)" }, resolved: { label: "Deployed", color: "hsl(142, 70%, 40%)" } };
          ...
          <div className="p-4 md:p-6 space-y-6 max-w-[1400px]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-border rounded-md overflow-hidden">
              {[
                ...
                { label: "Deployment rate", value: `${stats.resolutionRate}%` },
                { label: "Avg added/day", value: stats.avgPerDay },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-border rounded-md overflow-hidden">
              ...
              <div className="bg-background p-4">
                <p className="text-[13px] font-medium mb-1">Assets by status</p>
                <p className="text-[12px] text-muted-foreground mb-4">Distribution across lifecycle stages</p>
              ...
              {/* Severity Pie */}
              <div className="bg-background p-4">
                <p className="text-[13px] font-medium mb-1">Criticality distribution</p>
                <p className="text-[12px] text-muted-foreground mb-4">Breakdown by criticality level</p>
              ...
              {/* Trend Line */}
              <div className="bg-background p-4">
                <p className="text-[13px] font-medium mb-1">Asset registration trend</p>
                <p className="text-[12px] text-muted-foreground mb-4">New assets added per day (last 30 days)</p>
              ...
              {/* Open vs Resolved */}
              <div className="bg-background p-4">
                <p className="text-[13px] font-medium mb-1">Active vs deployed</p>
              ...
              <div className="bg-background p-4 lg:col-span-2">
                <p className="text-[13px] font-medium mb-1">Criticality by status</p>
                <p className="text-[12px] text-muted-foreground mb-4">How criticality levels distribute across each status</p>
