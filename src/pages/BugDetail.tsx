    ...
    return (
      <AppLayout>
        <div className="flex flex-col items-center justify-center h-full gap-3">
          <p className="text-[13px] text-muted-foreground">Asset not found</p>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 min-w-0 border-r border-border">
              ...
              {bug.steps_to_reproduce && (
                <div className="px-4 md:px-6 py-4 border-b border-border">
                  <p className="text-[12px] text-muted-foreground mb-2 font-medium">Acquisition Notes</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 border-b border-border">
                  {bug.expected_behavior && (
                    <div className="px-4 md:px-6 py-4 md:border-r border-border">
                      <p className="text-[12px] text-muted-foreground mb-2 font-medium">Specifications</p>
                      <p className="text-[13px]">{bug.expected_behavior}</p>
                    </div>
                  )}
                  {bug.actual_behavior && (
                    <div className="px-4 md:px-6 py-4">
                      <p className="text-[12px] text-muted-foreground mb-2 font-medium">Current Condition</p>
            ...
            <div className="w-full lg:w-64 shrink-0">
              ...
              <div className="px-4 py-3 space-y-3 text-[13px]">
                <div>
                  <p className="text-[12px] text-muted-foreground mb-0.5">Location / Department</p>
                  <p>{bug.environment || "—"}</p>
                </div>
                <div>
                  <p className="text-[12px] text-muted-foreground mb-0.5">Added</p>
