          ...
          <div className="p-4 md:p-6 space-y-6 max-w-[1400px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border rounded-md overflow-hidden">
              {[
                ...
                { label: "Active", value: counts.open },
                { label: "Deployed", value: counts.resolved },
              ].map((stat) => (
                ...
                <table className="w-full text-[13px]">
                  <thead>
                    <tr className="border-b border-border bg-muted/30">
                      ...
                      <th className="text-left font-medium text-muted-foreground px-3 py-2">Criticality</th>
                      <th className="text-left font-medium text-muted-foreground px-3 py-2">Added</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filtered.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="text-center py-8 text-muted-foreground text-[13px]">No assets found</td>
                      </tr>
                    ) : (
                      filtered.map((bug) => (
                        <tr
                      ...
                      <div className="space-y-1">
                        ...
                        {columnBugs.length === 0 && (
                          <div className="border border-dashed border-border rounded-md p-3 text-center">
                            <p className="text-[11px] text-muted-foreground">No assets</p>
                          </div>
                        )}
                      </div>
                    </div>
