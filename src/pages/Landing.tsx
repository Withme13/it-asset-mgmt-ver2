      ...
      <nav className="fixed top-0 z-50 w-full bg-background border-b border-border px-6">
        <div className="mx-auto flex h-[56px] max-w-[1200px] items-center justify-between">
          <Link to="/" className="flex items-center gap-2 -ml-0.5">
            <StackedLogo size={16} />
            <span className="text-[14px] font-bold text-foreground tracking-[0.08em] uppercase">AssetHub</span>
          </Link>
          ...
          <div className="pt-[52px] pb-16 relative flex">
            ...
            <div className="relative z-[3] flex-1 min-w-0 max-w-[540px]">
              <h1 className="text-[clamp(2rem,4vw,3.2rem)] font-[500] leading-[1.08] tracking-[-0.04em] text-foreground max-w-[540px]">
                IT asset management for teams that move fast
              </h1>
              <p className="mt-6 text-base leading-relaxed text-muted-foreground max-w-[420px]">
                Purpose-built for IT teams. Track, assign, and maintain every asset across your organization — without the spreadsheets.
              </p>
              ...
              <div className="flex min-h-[420px]">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                  ...
                  <div className="flex-1">
                    {[
                      { priority: "bg-destructive", id: "AST-142", title: "w-[180px]", status: "bg-warning" },
                      { priority: "bg-destructive", id: "AST-139", title: "w-[220px]", status: "bg-destructive" },
                      { priority: "bg-warning", id: "AST-138", title: "w-[160px]", status: "bg-primary" },
                      { priority: "bg-primary", id: "AST-135", title: "w-[200px]", status: "bg-success" },
                      { priority: "bg-muted-foreground/30", id: "AST-131", title: "w-[140px]", status: "bg-primary" },
                      { priority: "bg-warning", id: "AST-128", title: "w-[190px]", status: "bg-warning" },
                      { priority: "bg-primary", id: "AST-125", title: "w-[170px]", status: "bg-success" },
                    ].map((row, i) => (
      ...
      <section className="relative z-10 pt-24 pb-24 px-6 overflow-hidden">
        <div className="mx-auto max-w-[1200px] relative">
          ...
          <h2 className="text-[clamp(1.8rem,3vw,2.5rem)] font-[500] tracking-[-0.03em] text-foreground max-w-[500px] leading-[1.15]">
            Less spreadsheets.<br />More visibility.
          </h2>
          ...
          <div className="mt-16 border border-border">
            <div className="grid grid-cols-1 md:grid-cols-3">
              {[
                {
                  title: "Criticality tracking",
                  desc: "Four criticality levels. Maintenance schedules. One glance tells you which assets need attention — and when.",
                  graphic: "bars",
                },
                {
                  title: "Lifecycle workflows",
                  desc: "Register, assign, repair, deploy, retire. Every state change leaves a trail. Nothing gets lost.",
                  graphic: "flow",
                },
                {
                  title: "Real-time analytics",
                  desc: "Asset utilization. Criticality trends. Department breakdowns. Numbers that drive decisions — not vanity dashboards.",
                  graphic: "chart",
                },
              ].map((feature, i) => (
                <div
        ...
        <div className="mx-auto max-w-[1200px] relative">
          <div className="border border-border bg-background p-10 max-w-[720px] mx-auto">
            <blockquote className="text-[20px] font-[400] leading-[1.5] tracking-[-0.01em] text-foreground/85">
              "We replaced three spreadsheets with one tool. Asset visibility went from days to seconds. The team actually keeps it updated — that's the real win."
            </blockquote>
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[13px] text-muted-foreground ml-2">IT Operations Lead, Acme Corp</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 pt-32 pb-40 px-6 overflow-hidden">
        <div className="mx-auto max-w-[1200px] text-center relative">
          <h2 className="text-[clamp(2rem,4vw,3.2rem)] font-[500] tracking-[-0.035em] text-foreground leading-[1.1] mx-auto max-w-[560px]">
            Your assets aren't going to track themselves.
          </h2>
          <p className="mt-5 text-[15px] text-muted-foreground max-w-[400px] mx-auto">
            Two minutes to set up. No credit card. No sales call.<br />Just clear asset visibility, starting now.
          </p>
      ...
      <div className="relative z-10 border-t border-border">
        <div className="mx-auto max-w-[1200px] px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-2 -ml-0.5">
            <StackedLogo size={16} />
            <span className="text-[12px] font-bold text-foreground uppercase tracking-[0.08em]">AssetHub</span>
          </div>
